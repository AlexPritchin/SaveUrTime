...
NSString * const NEWS_IMAGES_DIR_NAME = @"/NewsImages";
NSString * const TASK_DATETIME_FORMAT = @"dd/MM/yyyy H:mm:ss";
...
CGFloat const PLACEHOLDER_TEXT_VIEW_TEXT_CHANGED_ANIMATION_DURATION = 0.1;
